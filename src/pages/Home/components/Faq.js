...
export const Faq = () => {
  ...
  return (
    <section className="my-10 p-7 border rounded dark:border-slate-700 shadow-sm">
      <h1 className="text-2xl text-center font-semibold dark:text-slate-700 mb-3 underline underline-offset-8">
        Question in mind?
      </h1>
      <div
        className=""
        ...
        data-active-classes="bg-white dark:bg-black-900 text-black-900 dark:text-black"
        data-inactive-classes="text-black-700 dark:text-black-700"
      >
        {faqs.map((faq) => (
